...
class Atualizar(Servico):
    ...
    def go(self, body = {}):
        ...
        event_result = self.servico().events().update(calendarId=self.calendarId, eventId=data[0]['id'], body=body).execute()
    ...
    def validation(self, data):
        ...
        for param in data:
            ...
            if 'id' not in param:
                return 'Ops, precisa informar o ID do evento para atualiza-lo.'
...
sys.modules[__name__] = Atualizar